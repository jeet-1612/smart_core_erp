...
<div class="row">
    <div class="col-md-8">
        <div class="card shadow mb-4">
            ...
            <div class="card-body">
                <form id="clientForm" action="/smart_core_erp/clients/process_edit/<?php echo $client->id; ?>" method="POST">
                    <div class="row">
                        <div class="col-md-6">
                            <div class="form-group mb-3">
                                <label class="form-label">Client Code</label>
                                <input type="text" class="form-control" value="<?php echo $client->client_code; ?>" readonly>
                    ...
                    <div class="form-group mb-3">
                        ...
                        <textarea class="form-control" id="address" name="address" rows="3"><?php echo $client->address; ?></textarea>
                    </div>
